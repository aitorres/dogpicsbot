...
Currently on [v1.4.2](https://github.com/aitorres/dogpicsbot/releases/tag/v1.3.0). For more information about versions and changes, refer to the [changelog](CHANGELOG.md).
